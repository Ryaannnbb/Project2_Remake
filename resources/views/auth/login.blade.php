    ...
    <main class="main-content  mt-0">
        ...
        <div class="page-header min-vh-100">
            ...
            <div class="row">
                ...
                <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('{{ asset('assets/img/icognito.jpg') }}');
            background-size: cover;">
                    <span class="mask bg-gradient-dark opacity-6"></span>
                    <h4 class="mt-5 text-white font-weight-bolder position-relative">"Secure Your Digital Realm"</h4>
                    <p class="text-white position-relative">Your login is the gateway to your digital fortress. Guard it with all your might.</p>
                </div>
                </div>
            </div>
            </div>
